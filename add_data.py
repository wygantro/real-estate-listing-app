...
### add_county.py ###
df_usa_counties = pd.read_csv('./data_frames/df_usa_counties.csv') 
...
### add_listings.py ###
df_listings = pd.read_csv('./data_frames/df_listings.csv') 
listings_info_list = []
# Iterate over each row
...
### add_image_file.py ###
i_f1 = Image_file(listing_id = 3,
                  image_file_name = 'photo_file_3_1')
db.session.add(i_f1)

i_f2 = Image_file(listing_id = 3,
                  image_file_name = 'photo_file_3_2')
db.session.add(i_f2)

i_f3 = Image_file(listing_id = 3,
                  image_file_name = 'photo_file_3_3')
db.session.add(i_f3)

i_f4 = Image_file(listing_id = 3,
                  image_file_name = 'photo_file_3_4')
db.session.add(i_f4)

i_f5 = Image_file(listing_id = 5,
                  image_file_name = 'photo_file_5_1')
db.session.add(i_f5)

i_f6 = Image_file(listing_id = 5,
                  image_file_name = 'photo_file_5_2')
db.session.add(i_f6)

i_f7 = Image_file(listing_id = 26,
                  image_file_name = 'photo_file_26_1')
db.session.add(i_f7)

i_f8 = Image_file(listing_id = 26,
                  image_file_name = 'photo_file_26_2')
db.session.add(i_f8)

i_f9 = Image_file(listing_id = 26,
